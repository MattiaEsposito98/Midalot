...
@section('content')
    <section class="admin-card">
        ...
        <div class="admin-card-body">
            <form action="{{ route('admin.minigiochi.update', $minigioco->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="admin-form-grid">
                    ...
                    <div class="full">
                        ...
                        @if ($minigioco->image_path)
                            <img src="{{ $minigioco->image_url }}" class="img-fluid rounded border mb-2" style="max-height: 140px;" alt="">
                        @else
